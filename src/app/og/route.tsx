  ...
  try {
    return new ImageResponse(
      (
        ...
        >
          <div tw="flex items-center pl-10 pr-10 h-10 border-b-4 border-gray-700/60">
            <div tw="border-l-4 border-r-4 w-full h-10 border-gray-700/60"></div>
          </div>

          <div tw="flex flex-1 pl-10 pr-10">
            <div tw="flex flex-col justify-center items-center w-full pl-20 pr-20 pt-14 pb-14 border-l-4 border-r-4 border-gray-700/60">
              ...
              <div tw="flex items-center border-t-4 border-gray-700/40 mt-8 pt-8">
                <img
                  src="https://sunnyk.netlify.app/Preview.jpg"
                  title="Sunny"
                  width="80px"
                  height="80px"
                ...
                >
                  <span>sunnyk.netlify.app</span>
                </div>
              </div>
            </div>
          </div>

          <div tw="flex items-center pl-10 pr-10 h-10 border-t-4 border-gray-700/60">
            <div tw="border-l-4 border-r-4 w-full h-10 border-gray-700/60"></div>
          </div>
        </div>
      ),
