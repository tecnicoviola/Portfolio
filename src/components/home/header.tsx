  ...
  return (
    <>
      ...
      <header className="border-b border-gray-30 dark:border-gray-500">
        <div className="mx-auto grid max-w-8xl grid-cols-12 px-2 xs:px-6 sm:px-10 xl:h-36 xl:mb-2">
          {/* H1 */}
          <div className="col-span-10 border-x border-gray-30 p-10 dark:border-gray-500 md:col-span-4 ">
            ...
            >
              {/* Logo */}
              <Logo className="h-[5.3rem] -mt-20 translate-y-12 -translate-x-5  lg:-translate-y-1 lg:py-2 lg:h-16 min-[896px]:h-24 xl:h-40 lg:-m-7 lg:mx-1" />
              ...
              <motion.div
                ...
                className="absolute right-0 top-0 hidden -translate-y-14 translate-x-12 rounded-full bg-green-500 px-4 py-3 text-lg font-bold leading-none text-white dark:text-gray-1000 xs:inline-block lg:translate-x-full lg:translate-y-0 lg:mx-40"
              >
