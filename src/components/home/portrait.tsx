...
import portrait from '@/components/home/suhani2.jpeg'

// Portrait component
export default function Portrait() {
  return (
    <div className="order-1 col-span-12 flex border-x border-gray-30 justify-center  pt-4 dark:border-gray-500 xs:px-8 xs:pt-8 md:order-2 md:col-span-6 md:border-l-0 md:border-r md:pb-8 min-[896px]:col-span-5 xl:order-2 xl:col-span-4">
      {/* Image */}
      <motion.div
        {...animate}
      ...
      >
        ...
        {/* Border */}
        <div className="flex w-full items-end rounded-xl border border-gray/20 p-3 dark:border-gray-50/20 ">
          {/* Label */}
