...
const favorite: CurrentlyPlaying = {
  ...
  title: 'Like I do',
  albumImageUrl:
    'https://i.scdn.co/image/ab67616d00001e02e649cde12610c45e05a10d44',
  songUrl: 'https://open.spotify.com/track/1TiZWEsxN85yLJBq56K8mG',
  isPlaying: false,
}
...
export function Listening() {
  ...
  return (
    <motion.div
      ...
      className="col-span-10 hidden flex-col items-end justify-end border-x border-t border-gray-30 bg-gradient-to-br from-gray-30/30 via-white to-white p-5 text-right dark:border-gray-500 dark:from-gray-700 dark:via-gray-1000 dark:to-gray-1000 md:col-span-6 md:flex md:border-l-0 md:border-t-0 min-[896px]:col-span-6 lg:col-span-4 xl:h-36"
    >
      {isLoading ? (
        <div></div>
      ) : error ? (
        ...
        <>
          <motion.div
            ...
            className="mb-4 w-full border-b border-gray-30 pb-4 text-sm font-bold uppercase text-gray-1000 dark:border-gray-500 dark:text-gray-200 xl:my-2 xl:pb-2 "
          >
          ...
          {playing ? (
            ...
            >
              <div>
                <div className="overflow-hidden whitespace-nowrap text-md font-medium text-gray-1000 dark:text-white">
                  {favorite.artist}
                </div>

                <div className="text-gray-40 dark:text-gray-50 text-lg">
                  {favorite.title}
                </div>
              </div>
